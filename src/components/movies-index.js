...
import {fetchMostPopular, fetchHighlyRated, fetchInTheaters, resetState} from '../actions/index'
...
export default connect(mapStateToProps, {fetchMostPopular, fetchHighlyRated, fetchInTheaters, resetState})(MoviesIndex);
