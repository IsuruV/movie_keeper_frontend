import {FETCH_POPULAR, FETCH_RATED, FETCH_THEATER, SEARCH, SEARCH_SUBMIT, DELETE_SEARCH, RESET_STATE, GET_MOVIE, GET_LINKS, GET_FB_ID, ADD_MOVIE, GET_MOVIE_LIST} from '../actions/index';
